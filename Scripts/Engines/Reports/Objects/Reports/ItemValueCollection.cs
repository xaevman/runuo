...
namespace RunUO.Engines.Reports
{
    ...
    public class ItemValueCollection : System.Collections.CollectionBase
    {
        ...
        /// </summary>
        public RunUO.Engines.Reports.ItemValue this[int index]
        {
            get
            {
                return ((RunUO.Engines.Reports.ItemValue)(this.List[index]));
            }
            set
            {
        ...
        public int Add(RunUO.Engines.Reports.ItemValue value)
        {
        ...
        public bool Contains(RunUO.Engines.Reports.ItemValue value)
        {
        ...
        public int IndexOf(RunUO.Engines.Reports.ItemValue value)
        {
        ...
        public void Remove(RunUO.Engines.Reports.ItemValue value)
        {
        ...
        public void Insert(int index, RunUO.Engines.Reports.ItemValue value)
        {
        ...
        public class ItemValueCollectionEnumerator : System.Collections.IEnumerator
        {
            ...
            /// </summary>
            private RunUO.Engines.Reports.ItemValue _currentElement;
            ...
            /// </summary>
            public RunUO.Engines.Reports.ItemValue Current
            {
                get
                {
                    if (((_index == -1) 
